...
const updatePassword = async (req, res) => {
    ...
    const oldPasswordQuery = `SELECT register.register_id, password FROM register INNER JOIN doctor ON 
    ...
    try {
        ...
        const result = await pool.query(oldPasswordQuery, [doctor_id])
